...
GoogleUrl = (function() {
    function GoogleUrl(sourceIdentifier) {
      ...
      if (this.sourceIdentifier.match(/http(s)*:/)) {
        ...
        this.key = "1isqjyBr8Es28b1JjikM9on43PzaGcnssA7ufqx0svoU";
      } else {
        this.key = this.sourceIdentifier;
      }
      this.jsonCellsUrl = "http://spreadsheets.google.com/feeds/cells/1isqjyBr8Es28b1JjikM9on43PzaGcnssA7ufqx0svoU/od6/public/basic?alt=json-in-script";
